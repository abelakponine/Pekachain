...
import { createHash, generateKeyPairSync, sign, verify, createSign,
    ...
    publicDecrypt, privateDecrypt } from "crypto";
...
class User {
    ...
    private publicKey: string|undefined = undefined; // for public signing and verification
    private privateKey: string|undefined = undefined; // for private signing and verification
